<div id="Ship_Window" class="Ship_Window">
		...
		<div style="float:left;">
			<table id="Weapons_Table">
				<tr>
					<td class="header" colspan="10">Weapon stats [Weapon slots: <?php echo $N_Weapons . "/". $Base_Weapon_Slots . "]"; ?></td>
				</tr>
				<tr>
...
?>
				<tr>
					<td style="background-color: #2F4382; text-align:center; width:14px;"><img style="width:9px;" src="img/SS_img/<?php echo $Build_Items["Base_Weapon" . $r]['Type']; ?>-Damage.png"/></td>
					<td><?php echo ($Build_Items["Base_Weapon" . $r]['Multifire'] > 1 ? "[Multifire x" . $Build_Items["Base_Weapon" . $r]['Multifire'] . "] " . $Build_Items["Base_Weapon" . $r]['Name'] : $Build_Items["Base_Weapon" . $r]['Name']); ?></td>
					<td style="text-align:right;" title="Calculated_Weapon_Sustainable_Crit_DPS<?php echo $r; ?>_Tooltip"><?php echo number_format($Calculated_Sustainable_Crit_DPS[$r],0,","," "); ?></td>
					...
					<td style="text-align:right;" title="Calculated_Weapon_EPS<?php echo $r; ?>_Tooltip"><?php echo number_format($Calculated_EPS[$r],0,","," ");; ?></td>
					...
					<td style="text-align:right;" title="Calculated_Weapon_Recoil<?php echo $r; ?>_Tooltip"><?php echo number_format($Calculated_Recoil[$r],2,","," "); ?></td>
		...
		<div style="float:left;">
			<table id="Ship_Information">
				<tr>
					<td class="header" colspan="2" style="text-align:center;"><b><?php echo $Build_Items["Base"]['Name']; ?></b></td>
				</tr>
				<tr>
					<td class="header" colspan="2" style="text-align:center;"><?php echo "Tech ".$Build_Items["Base"]['Tech']; ?></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="header2" style="text-align:right;">Emissive visibility:</td>
				...
				<tr>
					<td class="header2" style="text-align:right;">Worker req.:</td>
					<td class="value" title="Calculated_Worker_Req_Tooltip" style="text-align:right;"><?php echo number_format($Calculated_Worker_Req,0,","," "); ?></td>
				</tr>
				<?php 
				if (!isset($Calculated_Extracted_Materials)) {
					$Calculated_Extracted_Materials = array();
				}
				foreach ($Calculated_Extracted_Materials as $Material => $Material_Rate) {
					?>
					<tr>
						<td class="header2" style="text-align:right;"><?php echo $Material; ?></td>
						<td class="value" title="Calculated_<?php echo str_replace(" ", "_", $Material); ?>_Tooltip" style="text-align:right;"><?php echo number_format($Material_Rate,1,","," "); ?> /minute</td>
					</tr>
					<?php
				}
...
?>
	$('td[title=Calculated_<?php echo str_replace(" ", "_", $Stat_Name); ?>_Tooltip]').qtip({
		content: {
		...
		position: {
			my: 'top right',  // Position my top left...
			at: 'top left', // at the bottom right of...
			target: $('td[title=Calculated_<?php echo str_replace(" ", "_", $Stat_Name); ?>_Tooltip]') // my target
		}
	});
	<?php } ?>
</script>