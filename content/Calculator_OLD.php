                ...
                <fieldset>
                    <table class="innerTable" id="Build_Details_Table">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <p>
                                    <select id="Disable" class="select" style="width:310px;" data-placeholder="Toggle for filtering unusable items..." name="Disable" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
																			<option <?php echo ($Builds[$Build_ID]['Disable'] == 0 ? 'selected="selected"' : "") ?> value="0">Disable unusable items</option>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <p>
                                    <select id="Temp_Mods" class="select" style="width:310px;" data-placeholder="Toggle for including temporary bonuses in calculation..." name="Temp_Mods" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                        ...
                        <tr>
														<td style="" title="Ship"><img src="img/SS_img/Ship.png" style="width:14px;height:14px;"/></td>
                            <td colspan="3">
                                <p>
                                    <select id="Ship" class="select" style="width:310px;" data-placeholder="Please select a Ship..." name="Ship" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
                        ...
                        <tr>
							<td title="Controlbot"><img src="img/SS_img/Control-Bot.png" style="width:14px;height:14px;"/></td>
                            <td colspan="3">
                                <p>
                                    <select id="Controlbot" class="select" style="width:310px;" data-placeholder="Please select a Controlbot..." name="Controlbot" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
						...
						<?php } ?>
                        <tr>
							<td title="Shield"><img src="img/SS_img/Shield.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Shield" class="select" style="width:310px;" data-placeholder="Please select a Shield..." name="Shield" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Shield_Mods" class="multiselect" class="multiselect" data-placeholder="Please select Shield Mods..." name="Shield_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
                        ...
                        <tr>
							<td title="Energy"><img src="img/SS_img/Energy.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Energy" class="select" style="width:310px;" data-placeholder="Please select an Energy source..." name="Energy" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Energy_Mods" class="multiselect" data-placeholder="Please select Energy Mods..." name="Energy_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
                        ...
                        <tr>
							<td title="Engine"><img src="img/SS_img/Engine.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Engine" class="select" style="width:310px;" data-placeholder="Please select an Engine..." name="Engine" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Engine_Mods" class="multiselect" data-placeholder="Please select Engine Mods..." name="Engine_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
                        ...
                        <tr>
							<td title="Radar"><img src="img/SS_img/Radar.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Radar" class="select" style="width:310px;" data-placeholder="Please select a Radar..." name="Radar" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Radar_Mods" class="multiselect" data-placeholder="Please select Radar Mods..." name="Radar_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
                        ...
                        <tr>
							<td title="Scoop"><img src="img/SS_img/Scoop.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Scoop" class="select" style="width:310px;" data-placeholder="Please select a Scoop..." name="Scoop" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Scoop_Mods" class="multiselect" data-placeholder="Please select Scoop mods..." name="Scoop_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
						...
						<?php
							for ($r=1; $r <= $Ship_Hull_Expander_Slots; $r++) {
								?>
                        <tr>
							<td title="Hull_Expander<?php echo $r; ?>"><img src="img/SS_img/Hull-Expansions.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Hull_Expander<?php echo $r; ?>" class="select" style="width:310px;" data-placeholder="Please select a Hull Expander..." name="Hull_Expander<?php echo $r; ?>" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Hull_Expander<?php echo $r; ?>_Mods" class="multiselect" class="multiselect" data-placeholder="Please select Hull Expander Mods..." name="Hull_Expander<?php echo $r; ?>_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
						...
						<?php } ?>
                        <tr>
							<td title="Cloak"><img src="img/SS_img/Cloak.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Cloak" class="select" style="width:310px;" data-placeholder="Please select a Cloak..." name="Cloak" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Cloak_Mods" class="multiselect" class="multiselect" data-placeholder="Please select Cloak Mods..." name="Cloak_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
						...
						<?php
							for ($r=1; $r <= $Ship_Capacitor_Slots; $r++) {
								?>
                        <tr>
							<td title="Capacitor<?php echo $r; ?>"><img src="img/SS_img/Capacitors.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Capacitor<?php echo $r; ?>" class="select" style="width:310px;" data-placeholder="Please select a Capacitor..." name="Capacitor<?php echo $r; ?>" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td <?php if ($r == $Ship_Capacitor_Slots) { echo 'style="border-bottom:1px solid #ccc;"';} ?>>
                                <p>
                                    <select id="Capacitor<?php echo $r; ?>_Mods" <?php if ($r == $Ship_Capacitor_Slots) { echo 'style="border-bottom:1px solid #ccc;"';} ?> class="multiselect" data-placeholder="Please select Capacitor Mods..." name="Capacitor<?php echo $r; ?>_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
						...
						<?php
							...
							for ($r=1; $r <= $Ship_Overloader_Slots; $r++) {
								?>
                        <tr>
							<td title="Overloader<?php echo $r; ?>"><img src="img/SS_img/Overloaders.png" style="width:14px;height:14px;"/></td>
                            <td colspan="3">
                                <p>
                                    <select id="Overloader<?php echo $r; ?>" class="select" style="width:310px;" data-placeholder="Please select an Overloader..." name="Overloader<?php echo $r; ?>" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
						...
						<?php } ?>
                        <tr>
							<td title="Shield_Charger"><img src="img/SS_img/Shield-Chargers.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Shield_Charger" class="select" style="width:310px;" data-placeholder="Please select a Shield Charger..." name="Shield_Charger" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td>
                                <p>
                                    <select id="Shield_Charger_Mods" class="multiselect" class="multiselect" data-placeholder="Please select Shield Charger Mods..." name="Shield_Charger_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
                        ...
                        <tr>
							<td title="Tractor"><img src="img/SS_img/Tractor.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Tractor" class="select" style="width:310px;" data-placeholder="Please select a Tractor..." name="Tractor" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td style="border-bottom:1px solid #ccc;">
                                <p>
                                    <select id="Tractor_Mods" class="multiselect" class="multiselect" data-placeholder="Please select Tractor Mods..." name="Tractor_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
                        ...
                        <tr>
							<td title="Exterminator"><img src="img/SS_img/Exterminators.png" style="width:14px;height:14px;"/></td>
                            <td colspan="3">
                                <p>
                                    <select id="Exterminator" class="select" style="width:310px;" data-placeholder="Please select a Exterminator..." name="Exterminator" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
                        ...
                        <tr>
							<td title="Homing_Beacon"><img src="img/SS_img/Lighthouse.png" style="width:14px;height:14px;"/></td>
                            <td colspan="3">
                                <p>
                                    <select id="Homing_Beacon" class="select" style="width:310px;" data-placeholder="Please select a Homing beacon..." name="Homing_Beacon" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
                        ...
                        <tr>
							<td title="Aura_Generator"><img src="img/SS_img/Aura-Generators.png" style="width:14px;height:14px;"/></td>
                            <td colspan="3">
                                <p>
                                    <select id="Aura_Generator" class="select" style="width:310px;" data-placeholder="Please select a Aura Generator..." name="Aura_Generator" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
						...
						<?php
							...
							for ($r=1; $r <= $Ship_Weapon_Slots; $r++) {
								?>
                        <tr>
							<td title="Weapon<?php echo $r; ?>"><img src="img/SS_img/Weapon.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Weapon<? echo $r; ?>" class="select" style="width:310px;" data-placeholder="Please select a Weapon..." name="Weapon<? echo $r; ?>" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
							...
							<td <?php echo ($r == $Ship_Weapon_Slots ? 'style="border-bottom:1px solid #ccc;"' : ""); ?>>
                                <p>
                                    <select id="Weapon<?php echo $r;?>_Mods" class="multiselect" data-placeholder="Please select Weapon Mods..." name="Weapon<?php echo $r;?>_Mods[]" multiple class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <?php
						...
						<?php
							...
							for ($r=1; $r <= $Ship_Augmenter_Slots; $r++) {
								?>
                        <tr>
							<td title="Augmenter<?php echo $r; ?>"><img src="img/SS_img/Augmenters.png" style="width:14px;height:14px;"/></td>
                            <td colspan="3">
                                <p>
                                    <select id="Augmenter<? echo $r; ?>" class="select" style="width:310px;" data-placeholder="Please select an Augmenter..." name="Augmenter<? echo $r; ?>" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
						...
						<?php
							for ($r=1; $r <= $Ship_Diffuser_Slots; $r++) {
								?>
                        <tr>
												<td title="Diffuser<?php echo $r; ?>"><img src="img/SS_img/Diffusers.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Diffuser<? echo $r; ?>" class="select" style="width:310px;" data-placeholder="Please select a Diffuser..." name="Diffuser<? echo $r; ?>" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
						...
						<?php
							...
							for ($r=1; $r <= $Ship_Solar_Panel_Slots; $r++) {
								?>
                        <tr>
							<td title="Solar_Panel<?php echo $r; ?>"><img src="img/SS_img/Solar-Panels.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2" <?php echo ($r == $Ship_Solar_Panel_Slots && 1==2 ? 'style="border-bottom:1px solid #ccc;"' : ""); ?>>
                                <p>
                                    <select id="Solar_Panel<? echo $r; ?>" class="select" style="width:310px;" data-placeholder="Please select a Solar Panel..." name="Solar_Panel<? echo $r; ?>" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
						...
						<?php 
														...
														?>
											     <tr>
							<td title="Aura_Generator_Ally"><img src="img/SS_img/Aura-Generators.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2">
                                <p>
                                    <select id="Aura_Generator_Ally" class="select" style="width:310px;" data-placeholder="Please select a Allied Aura Generator..." name="Aura_Generator_Ally" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
                                        ...
                                        ?>
											     ...
											     <tr>
							<td title="Aura_Generator_Ally_2"><img src="img/SS_img/Aura-Generators.png" style="width:14px;height:14px;"/></td>
                            <td colspan="2" style="border-bottom:1px solid #ccc;">
                                <p>
                                    <select id="Aura_Generator_Ally_2" class="select" style="width:310px;" data-placeholder="Please select a Allied Aura Generator..." name="Aura_Generator_Ally_2" class="" <? echo ($Disable == TRUE ? 'disabled="disabled" ' : "");?>>
                                        <option value=""></option>
																				<option disabled value="0">Please use search field to find items!</option>
                                        <?php
...
// 		console.log("Start calculate: " + currenttime);
		$.ajax({
...
// 			var currenttime = new Date().getTime() / 1000;
// 			console.log("Return calculation: " + currenttime);
			var timestamp = new Date().getTime();
			$('div#Ship_Window td[title]').qtip('destroy', true);
			$('div#Ship_Window td[oldtitle]').qtip('destroy', true);
...
// 			console.log("Finished calculation output: " + currenttime);
		},
...
// 					console.log("Start: " + currenttime);
					...
					$.ajax({
						...
						dataType: "json",
						success: function(response) {
// 							console.log("Adding feedback div");
